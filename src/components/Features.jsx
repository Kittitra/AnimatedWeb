    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-5 md:px-10'>
        <div className='px-5 py-32'>
          ...
          text-lg text-blue-50 opacity-50'>
            Immerse yourself in a rich and 
            ever-expanding universe where a vibrant
            array of products converge into an 
            interconnected overlay experience
            on your world.
          </p>
        </div>
        
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden 
        rounded-md md:h-[65vh] transition-transform duration-300 ease-out">
        <BentoCard
